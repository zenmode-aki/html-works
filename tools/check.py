...
PHOTO_STORIES = {
    ...
    "eigenji-japan-heritage-temple",
    "ginza-tokyo-areas-are-deep",
    "han-river-night-ramen-and-chicken",
    "hisaya-odori-weekend-events",
    "honda-racing-gallery-as-a-new-fan",
    "hotel-day-use-in-southeast-asia",
    "jumped-on-a-jr-train-with-no-plan",
    "kfry-cheese-chicken-and-good-food-countries",
    "korean-idol-bangs-side-strands",
    "lost-a-shoe-in-tenma",
    "malaysia-apartment-stays",
    "mcdonalds-graduation",
    "night-bus-nagoya-to-tokyo-2000-yen",
    "nishiki-at-6am-full-of-young-people",
    "osu-for-a-japanese-feeling-in-nagoya",
    "petronas-towers-photo-business",
    "pit-garage-from-the-documentary",
    "seoul-city-share-bikes",
    "shinjuku-golden-gai-feels-different",
    "sunway-pyramid-mall-and-jollibee",
    "sunway-student-dorm-visit",
    "suzuka-700m-paddock-tunnel",
    "taylors-right-in-front-of-campus",
    "thermae-yu-shinjuku-when-tired",
    "trampoline-45-minutes-not-5",
    "tsuruma-park-is-my-pokemon-center",
    "yoro-falls-healing-walk",
    "zero-gravity-massage-in-sakae",
}
