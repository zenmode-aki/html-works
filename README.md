...
| フォント | **英語は今までどおり（Arial Rounded などの端末のフォント）。日本語は Zen Maru Gothic、韓国語は Gowun Dodum**（やわらかい丸ゴシック。どの端末でも同じに見えるよう Google Fonts から読み込む）。日本語・韓国語表示のときだけ `tools/i18n_runtime.js` が読み込む（2026-09-24 本人の希望） |
