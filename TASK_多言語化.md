...
- 現在ある言語：**en（元）/ ja / ko / zh / zh-Hant とフェーズBの23言語、フェーズCの8言語、フェーズDのRTL 4言語**。計40言語、記事は全171本
- ファイルの置き場所
...
| **B. 左から書く・ふつうの文字** | ✅ 完了・全171記事 | es, fr, de, pt, it, nl, pl, sv, nb, da, fi, cs, ro, ru, uk, tr, el, id, ms, vi, fil, ceb, sw |
| **C. タイ文字・インドの文字** | ✅ 完了・全171記事 | th, hi, bn, ta, te, mr, pa, ne。言語選択時に太字フォントを読み込む |
| **D. 右から書く言語** | ✅ 完了・全171記事 | ar, fa, ur, he。RTLレイアウトと360px表示を確認 |
...
- `README.md`・`CLAUDE.md`・`AGENTS.md` は現在40言語、全171記事の対応状況を記載する
