...
- 現在ある言語：**en（元）/ ja / ko / zh / zh-Hant とフェーズBの23言語**。計28言語、記事は全158本
- ファイルの置き場所
...
| **B. 左から書く・ふつうの文字** | ✅ 完了・全158記事 | es, fr, de, pt, it, nl, pl, sv, nb, da, fi, cs, ro, ru, uk, tr, el, id, ms, vi, fil, ceb, sw |
| **C. タイ文字・インドの文字** | 次 | th, hi, bn, ta, te, mr, pa, ne。端末にフォントがないことがある。§5 のフォントを確認 |
| **D. 右から書く言語** | その次 | ar, fa, ur, he。レイアウトの左右反転が要る。§6 を必ず読む |
